"""
LSTM Implementation: This code houses the latest LSTM tests. This is to be different than the main script, where 
the main script just focuses on the current experiment. This is meant to preserve the last working (happily done)
version of the LSTM code. There will similarly be a transformer version at some point too.
"""
